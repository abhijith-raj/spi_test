...
undefined_handler/9 (undefined_handler) @05c7c000
  ...
  Called by: 
  Calls: 
SysTick_Handler/8 (SysTick_Handler) @05c78b60
  Type: function definition analyzed
  ...
  Called by: 
  Calls: 
PendSV_Handler/7 (PendSV_Handler) @05c78540
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
DebugMon_Handler/6 (DebugMon_Handler) @05c78000
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
SVC_Handler/5 (SVC_Handler) @05c78d20
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
UsageFault_Handler/4 (UsageFault_Handler) @05c789a0
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
BusFault_Handler/3 (BusFault_Handler) @05c78700
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
MemManage_Handler/2 (MemManage_Handler) @05c78460
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
HardFault_Handler/1 (HardFault_Handler) @05c781c0
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
NMI_Handler/0 (NMI_Handler) @05c5ae00
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
...
;; Function NMI_Handler (NMI_Handler, funcdef_no=0, decl_uid=5646, cgraph_uid=1, symbol_order=0)
...
;; Function HardFault_Handler (HardFault_Handler, funcdef_no=1, decl_uid=5648, cgraph_uid=2, symbol_order=1)
...
;; Function MemManage_Handler (MemManage_Handler, funcdef_no=2, decl_uid=5650, cgraph_uid=3, symbol_order=2)
...
;; Function BusFault_Handler (BusFault_Handler, funcdef_no=3, decl_uid=5652, cgraph_uid=4, symbol_order=3)
...
;; Function UsageFault_Handler (UsageFault_Handler, funcdef_no=4, decl_uid=5654, cgraph_uid=5, symbol_order=4)
...
;; Function SVC_Handler (SVC_Handler, funcdef_no=5, decl_uid=5684, cgraph_uid=6, symbol_order=5)
...
;; Function DebugMon_Handler (DebugMon_Handler, funcdef_no=6, decl_uid=5656, cgraph_uid=7, symbol_order=6)
...
;; Function PendSV_Handler (PendSV_Handler, funcdef_no=7, decl_uid=5658, cgraph_uid=8, symbol_order=7)
...
;; Function SysTick_Handler (SysTick_Handler, funcdef_no=8, decl_uid=5660, cgraph_uid=9, symbol_order=8)
...
;; Function undefined_handler (undefined_handler, funcdef_no=9, decl_uid=5662, cgraph_uid=10, symbol_order=9) (executed once)
