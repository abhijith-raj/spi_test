...
NVIC_SetPriority/3 (NVIC_SetPriority) @072a82a0
  ...
  Called by: 
  Calls: 
NVIC_DisableIRQ/2 (NVIC_DisableIRQ) @072a8000
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
NVIC_EnableIRQ/1 (NVIC_EnableIRQ) @07294b60
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
NVIC_SetPriorityGrouping/0 (NVIC_SetPriorityGrouping) @07294d20
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
;; Function NVIC_SetPriorityGrouping (NVIC_SetPriorityGrouping, funcdef_no=0, decl_uid=7717, cgraph_uid=1, symbol_order=0)
...
;; Function NVIC_EnableIRQ (NVIC_EnableIRQ, funcdef_no=1, decl_uid=7719, cgraph_uid=2, symbol_order=1)
...
;; Function NVIC_DisableIRQ (NVIC_DisableIRQ, funcdef_no=2, decl_uid=7721, cgraph_uid=3, symbol_order=2)
...
;; Function NVIC_SetPriority (NVIC_SetPriority, funcdef_no=3, decl_uid=7724, cgraph_uid=4, symbol_order=3)
