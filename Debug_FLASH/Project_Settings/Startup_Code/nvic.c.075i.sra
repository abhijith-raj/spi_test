Creating summary for NVIC_SetPriority/3:
  Descriptor for parameter 0 IRQnD.7734
    not a candidate for splitting
  Descriptor for parameter 1 priorityD.7735
    not a candidate for splitting


Creating summary for NVIC_DisableIRQ/2:
  Descriptor for parameter 0 IRQnD.7731
    not a candidate for splitting


Creating summary for NVIC_EnableIRQ/1:
  Descriptor for parameter 0 IRQnD.7728
    not a candidate for splitting


Creating summary for NVIC_SetPriorityGrouping/0:
  Descriptor for parameter 0 PriorityGroupD.7725
    not a candidate for splitting
