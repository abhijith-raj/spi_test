...
;; Function startup_go_to_user_mode (startup_go_to_user_mode, funcdef_no=0, decl_uid=5797, cgraph_uid=1, symbol_order=3)
...
;; Function default_interrupt_routine (default_interrupt_routine, funcdef_no=1, decl_uid=5774, cgraph_uid=2, symbol_order=4) (executed once)
...
;; Function Sys_GetCoreID (Sys_GetCoreID, funcdef_no=2, decl_uid=5640, cgraph_uid=3, symbol_order=5)
...
;; Function SystemInit (SystemInit, funcdef_no=3, decl_uid=5772, cgraph_uid=4, symbol_order=6)
