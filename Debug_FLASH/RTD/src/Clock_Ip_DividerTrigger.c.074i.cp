...
;; Function Clock_Ip_Callback_DividerTriggerEmpty (Clock_Ip_Callback_DividerTriggerEmpty, funcdef_no=0, decl_uid=6437, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat (Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat, funcdef_no=1, decl_uid=6439, cgraph_uid=2, symbol_order=1)
...
;; Function Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat (Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat, funcdef_no=2, decl_uid=6441, cgraph_uid=3, symbol_order=2)
