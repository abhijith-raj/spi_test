...
PcfsRate.0/9 (PcfsRate) @06023360
...
AMax.1/8 (AMax) @06023318
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
Clock_Ip_FreqIds/7 (Clock_Ip_FreqIds) @060232d0
  Type: variable
  ...
  Varpool flags:
Clock_Ip_pxConfig/6 (Clock_Ip_pxConfig) @06023288
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
Hash.2/5 (Hash) @06023240
  ...
  Availability: available
  Varpool flags:
Clock_Ip_apxCgmPcfs/4 (Clock_Ip_apxCgmPcfs) @060231f8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
Clock_Ip_au8ClockFeatures/3 (Clock_Ip_au8ClockFeatures) @060231b0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axPcfsCallbacks/2 (Clock_Ip_axPcfsCallbacks) @06015900
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1 (Clock_Ip_CgmXPcfsSdurDivcDiveDivs) @0601d460
  ...
  Called by: 
  Calls: 
Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/0 (Clock_Ip_ProgressiveFrequencyClockSwitchEmpty) @05e5e460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
;; Function Clock_Ip_ProgressiveFrequencyClockSwitchEmpty (Clock_Ip_ProgressiveFrequencyClockSwitchEmpty, funcdef_no=0, decl_uid=6438, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_CgmXPcfsSdurDivcDiveDivs (Clock_Ip_CgmXPcfsSdurDivcDiveDivs, funcdef_no=1, decl_uid=6441, cgraph_uid=2, symbol_order=1)
