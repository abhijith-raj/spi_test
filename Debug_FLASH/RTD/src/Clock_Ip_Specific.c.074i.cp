...
Clock_Ip_PRAMCSetRamIWS.part.0/26 (Clock_Ip_PRAMCSetRamIWS.part.0) @061558c0
  ...
  Calls: 
Clock_Ip_FreqIds/25 (Clock_Ip_FreqIds) @06146678
  Type: variable
  ...
  Varpool flags:
Clock_Ip_pxConfig/24 (Clock_Ip_pxConfig) @06146630
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Clock_Ip_ReportClockErrors/23 (Clock_Ip_ReportClockErrors) @0610c7e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_TimeoutExpired/22 (Clock_Ip_TimeoutExpired) @0610c700
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/21 (Clock_Ip_StartTimeout) @0610c620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_axIntOscCallbacks/20 (Clock_Ip_axIntOscCallbacks) @06108e10
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
Clock_Ip_au8IrcoscCallbackIndex/19 (Clock_Ip_au8IrcoscCallbackIndex) @06108dc8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_bObjectsAreInitialized.0/18 (Clock_Ip_bObjectsAreInitialized) @06108d80
...
Clock_Ip_PRAMCSetRamIWS/17 (Clock_Ip_PRAMCSetRamIWS) @061037e0
  Type: function definition analyzed
...
Clock_Ip_FLASH_SetFlashIWS/16 (Clock_Ip_FLASH_SetFlashIWS) @06103540
  Type: function definition analyzed
  Visibility: externally_visible public
...
Clock_Ip_Command/15 (Clock_Ip_Command) @061032a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Clock_Ip_ClockPowerModeChangeNotification/14 (Clock_Ip_ClockPowerModeChangeNotification) @06103000
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
Clock_Ip_ClockInitializeObjects/13 (Clock_Ip_ClockInitializeObjects) @06021a80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  ...
  Calls: 
EnableSircInStandbyMode/12 (EnableSircInStandbyMode) @060212a0
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Calls: 
   Indirect call(1073741824 (estimated locally),1.00 per call)  Num speculative call targets: 0
DisableSircInStandbyMode/11 (DisableSircInStandbyMode) @06021ee0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Clock_Ip_pxSircStdbyClock/0 (read) 
  Referring: 
  ...
  Calls: 
   Indirect call(1073741824 (estimated locally),1.00 per call)  Num speculative call targets: 0
EnableFircInStandbyMode/10 (EnableFircInStandbyMode) @06021c40
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Calls: 
   Indirect call(1073741824 (estimated locally),1.00 per call)  Num speculative call targets: 0
DisableFircInStandbyMode/9 (DisableFircInStandbyMode) @060219a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Clock_Ip_pxFircStdbyClock/1 (read) 
  Referring: 
  ...
  Calls: 
   Indirect call(1073741824 (estimated locally),1.00 per call)  Num speculative call targets: 0
Clock_Ip_McMeEnterKey/7 (Clock_Ip_McMeEnterKey) @06021460
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: Clock_Ip_PowerClockIpModules/3 (114863530 (estimated locally),0.33 per call) Clock_Ip_PowerClockIpModules/3 (114863530 (estimated locally),0.33 per call) Clock_Ip_PowerClockIpModules/3 (114863529 (estimated locally),0.33 per call) Clock_Ip_PowerClockIpModules/3 (114863529 (estimated locally),0.33 per call) 
  Calls: 
Clock_Ip_SetFlashWaitStates/6 (Clock_Ip_SetFlashWaitStates) @060211c0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Clock_Ip_SetRamWaitStates/5 (Clock_Ip_SetRamWaitStates) @06018a80
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Clock_Ip_CodeInRamSetFlashWaitStates/4 (Clock_Ip_CodeInRamSetFlashWaitStates) @06018d20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
Clock_Ip_PowerClockIpModules/3 (Clock_Ip_PowerClockIpModules) @060189a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
...
Clock_Ip_SetFlashWaitStatesCallback/2 (Clock_Ip_SetFlashWaitStatesCallback) @060153a8
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
...
Clock_Ip_pxFircStdbyClock/1 (Clock_Ip_pxFircStdbyClock) @06015318
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  ...
  Availability: available
  Varpool flags:
Clock_Ip_pxSircStdbyClock/0 (Clock_Ip_pxSircStdbyClock) @06015288
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
...
;; Function Clock_Ip_CodeInRamSetFlashWaitStates (Clock_Ip_CodeInRamSetFlashWaitStates, funcdef_no=1, decl_uid=6439, cgraph_uid=2, symbol_order=4)
...
;; Function Clock_Ip_McMeEnterKey (Clock_Ip_McMeEnterKey, funcdef_no=4, decl_uid=6244, cgraph_uid=5, symbol_order=7)
...
;; Function DisableFircInStandbyMode (DisableFircInStandbyMode, funcdef_no=6, decl_uid=6236, cgraph_uid=7, symbol_order=9)
...
;; Function EnableFircInStandbyMode (EnableFircInStandbyMode, funcdef_no=7, decl_uid=6238, cgraph_uid=8, symbol_order=10)
...
;; Function DisableSircInStandbyMode (DisableSircInStandbyMode, funcdef_no=8, decl_uid=6240, cgraph_uid=9, symbol_order=11)
...
;; Function EnableSircInStandbyMode (EnableSircInStandbyMode, funcdef_no=9, decl_uid=6242, cgraph_uid=10, symbol_order=12)
...
;; Function Clock_Ip_ClockPowerModeChangeNotification (Clock_Ip_ClockPowerModeChangeNotification, funcdef_no=11, decl_uid=6409, cgraph_uid=12, symbol_order=14)
...
;; Function Clock_Ip_Command (Clock_Ip_Command, funcdef_no=12, decl_uid=6426, cgraph_uid=13, symbol_order=15)
...
;; Function Clock_Ip_FLASH_SetFlashIWS (Clock_Ip_FLASH_SetFlashIWS, funcdef_no=13, decl_uid=6471, cgraph_uid=14, symbol_order=16)
...
;; Function Clock_Ip_SetFlashWaitStates (Clock_Ip_SetFlashWaitStates, funcdef_no=3, decl_uid=6423, cgraph_uid=4, symbol_order=6)
...
;; Function Clock_Ip_PRAMCSetRamIWS (Clock_Ip_PRAMCSetRamIWS, funcdef_no=14, decl_uid=6446, cgraph_uid=15, symbol_order=17)
...
;; Function Clock_Ip_SetRamWaitStates (Clock_Ip_SetRamWaitStates, funcdef_no=2, decl_uid=6421, cgraph_uid=3, symbol_order=5)
