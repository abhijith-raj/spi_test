...
;; Function Det_TestLastReportError (Det_TestLastReportError, funcdef_no=0, decl_uid=5696, cgraph_uid=1, symbol_order=0)
...
;; Function Det_TestLastReportRuntimeError (Det_TestLastReportRuntimeError, funcdef_no=1, decl_uid=5701, cgraph_uid=2, symbol_order=1)
...
;; Function Det_TestLastReportTransientFault (Det_TestLastReportTransientFault, funcdef_no=2, decl_uid=5706, cgraph_uid=3, symbol_order=2)
...
;; Function Det_TestNoError (Det_TestNoError, funcdef_no=3, decl_uid=5708, cgraph_uid=4, symbol_order=3)
...
;; Function Det_TestNoRuntimeError (Det_TestNoRuntimeError, funcdef_no=4, decl_uid=5710, cgraph_uid=5, symbol_order=4)
...
;; Function Det_TestNoTransientFault (Det_TestNoTransientFault, funcdef_no=5, decl_uid=5712, cgraph_uid=6, symbol_order=5)
