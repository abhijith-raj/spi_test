Creating summary for IntCtrl_Ip_SetTargetCores/22:
  Descriptor for parameter 0 eIrqNumberD.5956
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 u8TargetCoresD.5957
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_GetActive/21:
  Descriptor for parameter 0 eIrqNumberD.5953
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_GetPending/20:
  Descriptor for parameter 0 eIrqNumberD.5950
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_SetPending/19:
  Descriptor for parameter 0 eIrqNumberD.5947
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_ClearPending/18:
  Descriptor for parameter 0 eIrqNumberD.5944
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_GetPriority/17:
  Descriptor for parameter 0 eIrqNumberD.5941
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_SetPriority/16:
  Descriptor for parameter 0 eIrqNumberD.5937
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 u8PriorityD.5938
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_DisableIrq/15:
  Descriptor for parameter 0 eIrqNumberD.5934
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_EnableIrq/14:
  Descriptor for parameter 0 eIrqNumberD.5931
    (locally) unused
    not a candidate for splitting


Creating summary for IntCtrl_Ip_InstallHandler/13:
  Descriptor for parameter 0 eIrqNumberD.5926
    unused with 1 call_uses
    not a candidate
  Descriptor for parameter 1 pfNewHandlerD.5927
    unused with 1 call_uses
    not a candidate
  Descriptor for parameter 2 pfOldHandlerD.5928
    unused with 1 call_uses
...
Creating summary for IntCtrl_Ip_ConfigIrqRouting/12:
  Descriptor for parameter 0 routeConfigD.5919
    not a candidate for splitting


Creating summary for IntCtrl_Ip_Init/11:
  Descriptor for parameter 0 pIntCtrlCtrlConfigD.5912
    not a candidate for splitting


Creating summary for IntCtrl_Ip_SetTargetCoresPrivileged/10:
  Descriptor for parameter 0 eIrqNumberD.5908
    not a candidate for splitting
  Descriptor for parameter 1 u8TargetCoresD.5909
    not a candidate for splitting


Creating summary for IntCtrl_Ip_GetActivePrivileged/9:
  Descriptor for parameter 0 eIrqNumberD.5905
    not a candidate for splitting


Creating summary for IntCtrl_Ip_GetPendingPrivileged/8:
  Descriptor for parameter 0 eIrqNumberD.5902
    not a candidate for splitting


Creating summary for IntCtrl_Ip_SetPendingPrivileged/7:
  Descriptor for parameter 0 eIrqNumberD.5899
    not a candidate for splitting


Creating summary for IntCtrl_Ip_ClearPendingPrivileged/6:
  Descriptor for parameter 0 eIrqNumberD.5896
    not a candidate for splitting


Creating summary for IntCtrl_Ip_GetPriorityPrivileged/5:
  Descriptor for parameter 0 eIrqNumberD.5891
    not a candidate for splitting


Creating summary for IntCtrl_Ip_SetPriorityPrivileged/4:
  Descriptor for parameter 0 eIrqNumberD.5886
    not a candidate for splitting
  Descriptor for parameter 1 u8PriorityD.5887
    not a candidate for splitting


Creating summary for IntCtrl_Ip_DisableIrqPrivileged/3:
  Descriptor for parameter 0 eIrqNumberD.5883
    not a candidate for splitting


Creating summary for IntCtrl_Ip_EnableIrqPrivileged/2:
  Descriptor for parameter 0 eIrqNumberD.5880
    not a candidate for splitting


Creating summary for IntCtrl_Ip_InstallHandlerPrivileged/1:
  Descriptor for parameter 0 eIrqNumberD.5873
    not a candidate for splitting
  Descriptor for parameter 1 pfNewHandlerD.5874
    not a candidate for splitting
  Descriptor for parameter 2 pfOldHandlerD.5875
    not a candidate for splitting


Creating summary for DevAssert/0:
  Descriptor for parameter 0 xD.5816
    not a candidate for splitting
