...
;; Function OsIf_Init (OsIf_Init, funcdef_no=5, decl_uid=5645, cgraph_uid=6, symbol_order=5)
...
;; Function OsIf_GetCounter (OsIf_GetCounter, funcdef_no=6, decl_uid=5647, cgraph_uid=7, symbol_order=6)
...
;; Function OsIf_GetElapsed (OsIf_GetElapsed, funcdef_no=7, decl_uid=5650, cgraph_uid=8, symbol_order=7)
...
;; Function OsIf_SetTimerFrequency (OsIf_SetTimerFrequency, funcdef_no=8, decl_uid=5653, cgraph_uid=9, symbol_order=8)
...
;; Function OsIf_MicrosToTicks (OsIf_MicrosToTicks, funcdef_no=9, decl_uid=5656, cgraph_uid=10, symbol_order=9)
