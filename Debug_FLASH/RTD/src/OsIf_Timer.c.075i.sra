Creating summary for OsIf_MicrosToTicks/9:
  Descriptor for parameter 0 MicrosD.5714
    not a candidate for splitting
  Descriptor for parameter 1 SelectedCounterD.5715
    not a candidate for splitting


Creating summary for OsIf_SetTimerFrequency/8:
  Descriptor for parameter 0 FreqD.5707
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 SelectedCounterD.5708
    (locally) unused
    not a candidate for splitting


Creating summary for OsIf_GetElapsed/7:
  Descriptor for parameter 0 CurrentRefD.5699
    unused with 0 call_uses
    by_ref with 0 pass throughs
  Descriptor for parameter 1 SelectedCounterD.5700
    not a candidate
----------------------------------------
  Descriptor for parameter 0 CurrentRefD.5699
    (locally) unused
...
Creating summary for OsIf_GetCounter/6:
  Descriptor for parameter 0 SelectedCounterD.5692
    (locally) unused
    not a candidate for splitting


Creating summary for OsIf_Init/5:
  Descriptor for parameter 0 ConfigD.5689
    not a candidate for splitting
