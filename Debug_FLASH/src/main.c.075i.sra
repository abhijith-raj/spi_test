Creating summary for main/42:


Creating summary for reverseBits/41:
  Descriptor for parameter 0 numD.8295
    not a candidate for splitting


Creating summary for iotsm_dbg_log/40:
Function cannot change signature.
Creating summary for iotsm_uart_tx/39:
  Descriptor for parameter 0 port_numD.8278
    not a candidate
  Descriptor for parameter 1 p_logD.8279
    unused with 1 call_uses
    by_ref with 1 pass throughs
  Descriptor for parameter 2 lenD.8280
    not a candidate
----------------------------------------
  Descriptor for parameter 0 port_numD.8278
    not a candidate for splitting
...
Creating summary for iotsm_init_debug_port/38:



========== IPA-SRA IPA stage ==========

Summary for node main/42:
  Returns value
  No parameter information. 

  Summary for edge main/42->iotsm_dbg_log/40:
    return value ignored
  Summary for edge main/42->reverseBits/41:
  Summary for edge main/42->iotsm_dbg_log/40:
    return value ignored
  Summary for edge main/42->iotsm_dbg_log/40:
    return value ignored
  Summary for edge main/42->iotsm_dbg_log/40:
    return value ignored
  Summary for edge main/42->Lpspi_Ip_SyncTransmitHalfDuplex/62:
  Summary for edge main/42->Lpspi_Ip_SyncTransmitHalfDuplex/62:
    return value ignored
  Summary for edge main/42->iotsm_dbg_log/40:
    return value ignored
  Summary for edge main/42->Lpspi_Ip_UpdateTransferMode/61:
  Summary for edge main/42->Lpspi_Ip_UpdateLsb/60:
    return value ignored
  Summary for edge main/42->iotsm_dbg_log/40:
    return value ignored
  Summary for edge main/42->Lpspi_Ip_UpdateFrameSize/58:
    return value ignored
  Summary for edge main/42->Lpspi_Ip_Init/56:
    return value ignored
  Summary for edge main/42->iotsm_init_debug_port/38:
    return value ignored
  Summary for edge main/42->IntCtrl_Ip_ConfigIrqRouting/54:
    return value ignored
  Summary for edge main/42->IntCtrl_Ip_Init/52:
    return value ignored
  Summary for edge main/42->Siul2_Port_Ip_Init/50:
    return value ignored
  Summary for edge main/42->Clock_Ip_Init/48:
    return value ignored

Summary for node reverseBits/41:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting


Summary for node iotsm_dbg_log/40:
  Function does not have any associated IPA-SRA summary

Summary for node iotsm_uart_tx/39:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  ...
  Summary for edge iotsm_uart_tx/39->Lpuart_Uart_Ip_SyncSend/43:
...
Summary for node iotsm_init_debug_port/38:
  No parameter information. 

  Summary for edge iotsm_init_debug_port/38->IntCtrl_Ip_EnableIrq/68:
    return value ignored
  Summary for edge iotsm_init_debug_port/38->IntCtrl_Ip_InstallHandler/66:
    return value ignored
  Summary for edge iotsm_init_debug_port/38->Lpuart_Uart_Ip_Init/64:
    return value ignored
  Summary for edge iotsm_init_debug_port/38->OsIf_Init/63:
    return value ignored


Function iotsm_uart_tx/39 disqualified because it cannot be made local.
Function reverseBits/41 disqualified because it cannot be made local.
Function main/42 disqualified because it cannot be made local.
