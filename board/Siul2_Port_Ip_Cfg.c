...
- pin_list:
  - {pin_num: '147', peripheral: FLEXIO, signal: 'flexio_d, 13', pin_signal: PTE2, identifier: D13SOUT, direction: OUTPUT, pullEnable: disabled}
  - {pin_num: '98', peripheral: FLEXIO, signal: 'flexio_d, 12', pin_signal: PTC8, identifier: D12CLK, direction: OUTPUT, pullEnable: disabled}
  - {pin_num: '95', peripheral: FLEXIO, signal: 'flexio_d, 14', pin_signal: PTB0, identifier: D14CS0, direction: OUTPUT, pullEnable: disabled}
  - {pin_num: '163', peripheral: FLEXIO, signal: 'flexio_d, 3', pin_signal: PTE0, direction: INPUT, pullEnable: disabled}
  - {pin_num: '110', peripheral: LPSPI_1, signal: 'lpspi_pcs, 3', pin_signal: PTB17, direction: OUTPUT}
  - {pin_num: '145', peripheral: LPUART_6, signal: lpuart_rx, pin_signal: PTA15}
  - {pin_num: '143', peripheral: LPUART_6, signal: lpuart_tx, pin_signal: PTA16, direction: OUTPUT}
  - {pin_num: '112', peripheral: LPSPI_1, signal: lpspi_sout, pin_signal: PTB16, direction: OUTPUT}
  - {pin_num: '114', peripheral: LPSPI_1, signal: 'lpspi_sck, sck', pin_signal: PTB14, direction: OUTPUT}
  - {pin_num: '113', peripheral: LPSPI_1, signal: lpspi_sin, pin_signal: PTB15, direction: INPUT}
