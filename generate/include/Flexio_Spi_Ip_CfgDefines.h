...
#ifndef FLEXIO_0_PIN_13_USED
    #define FLEXIO_0_PIN_13_USED
#else
    #error "PIN_13 cannot be used by SPI driver to configure as TX channel. Channel locked by another driver!"
#endif

#ifndef FLEXIO_0_PIN_3_USED
    #define FLEXIO_0_PIN_3_USED
#else
    #error "PIN_3 cannot be used by SPI driver to configure as RX channel. Channel locked by another driver!"
#endif
