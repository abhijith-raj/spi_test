...
const Dma_Ip_GlobalConfigType LogicChannel0GlobalConfigPB =
{
	...
	{
		/* uint8 SourceMux; */               DMA_IP_REQ_MUX0_LPSPI1_TX,
	...
	{
		/* uint8 Group; */                   DMA_IP_GROUP_PRIO1,
...
const Dma_Ip_GlobalConfigType LogicChannel1GlobalConfigPB =
{
	...
	{
		/* uint8 SourceMux; */               DMA_IP_REQ_MUX0_LPSPI1_RX,
		/* boolean EnSourceMux; */           (boolean)TRUE,
		/* boolean EnTriggerMux; */          (boolean)FALSE,
		/* boolean EnRequest; */             (boolean)FALSE,
	}, /* Request */
...
extern void Lpspi_Ip_LPSPI_1_IrqTxDmaHandler(void);
...
{
		{
				...
				/* uint8 HwInst; */                   DMA_IP_HW_INST_0,
				/* uint8 HwChId; */                   0U,
				/* Dma_Ip_Callback IntCallback; */    Lpspi_Ip_LPSPI_1_IrqTxDmaHandler,
...
extern void Lpspi_Ip_LPSPI_1_IrqRxDmaHandler(void);
...
{
		{
				...
				/* uint8 HwInst; */                   DMA_IP_HW_INST_0,
				/* uint8 HwChId; */                   1U,
				/* Dma_Ip_Callback IntCallback; */    Lpspi_Ip_LPSPI_1_IrqRxDmaHandler,
				/* Dma_Ip_Callback ErrIntCallback; */ NULL_PTR,
		}, /* Dma_Ip_LogicChannelIdType */
