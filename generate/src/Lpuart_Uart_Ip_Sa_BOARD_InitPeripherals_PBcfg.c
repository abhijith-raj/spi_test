...
#define LPUART_UART_IP_SA_PBCFG_BOARD_INITPERIPHERALS_SW_PATCH_VERSION_C              1
...
const Lpuart_Uart_Ip_UserConfigType Lpuart_Uart_Ip_xHwConfigPB_6_BOARD_INITPERIPHERALS =
{
    /* Actual baudrate */
    115942,
    /* Baudrate mantissa*/
    ...
    &Lpuart_Uart_Ip_apStateStructure[6U]
};
